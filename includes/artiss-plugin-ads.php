...
function artiss_plugin_ads( $trans ) {
    ...
    $code = '<p><div style="width: 750px; height: 125px; border: 1px solid #ddd; padding: 10px;">' . $newline;
    $code .= $code1 . $newline . $code2 . $newline;
    $code .= '<span style="font-weight: bold">Donate</span>' . $newline;
    $code .= '<br/>If you like this plugin and appreciate the effort being put into it, <a href="http://www.artiss.co.uk/donate">please consider donating</a>.<br/>' . $newline;
    $code .= '<br/><span style="font-weight: bold">Follow Me</span>' . $newline;
    $code .= '<br/>Please stay in touch with the latest news via one of the following social streams...<br/>' . $newline;

...
function acc_menu() {
	...
	add_menu_page( __( 'Artiss Currency Converter Settings', 'currency-converter' ), __( 'Currency', 'currency-converter' ), 'edit_posts', 'acc-options', 'acc_options', plugins_url() . '/artiss-currency-converter/images/menu_icon.png' );

    // Add search sub-menu

    if ( $contextual_help == 'new' ) { global $acc_options_hook; }

	$acc_options_hook = add_submenu_page( 'acc-options', __( 'Artiss Currency Converter Options', 'currency-converter' ), __( 'Options', 'currency-converter' ), 'edit_posts', 'acc-options', 'acc_options' );
    ...
    $acc_rates_hook = add_submenu_page( 'acc-options', __( 'Artiss Currency Converter Rates', 'currency-converter' ), __( 'Rates', 'currency-converter' ), 'manage_options', 'acc-rates', 'acc_rates' );
    ...
    if ( function_exists( 'wp_readme_parser' ) ) {
        add_submenu_page( 'acc-options', __( 'Artiss Currency Converter README', 'currency-converter' ), __( 'README', 'currency-converter' ), 'edit_posts', 'acc-readme', 'acc_readme' );
    }

    // Add support sub-menu

    add_submenu_page( 'acc-options', __( 'Artiss Currency Converter Support', 'currency-converter' ), __( 'Support', 'currency-converter' ), 'edit_posts', 'acc-support', 'acc_support' );
...
function acc_admin_print_footer_scripts() {
    ...
    $pointer_content .= '<p>' . __( 'A new menu has been added to the sidebar. This will allow you to change the default options (recommended!) and see the current exchange rate information.', 'currency-converter' );
?>
<script>
jQuery(function () {

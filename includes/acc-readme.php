...
if ( !function_exists( 'wp_readme_parser' ) ) {
    ...
    echo readme_parser( array( 'exclude' => 'meta,upgrade notice,screenshots,support,changelog,links,installation,licence', 'ignore' => 'For help with this plugin,,Other Notes' ), 'http://plugins.svn.wordpress.org/artiss-currency-converter/tags/' . artiss_currency_converter_version . '/readme.txt' );
}
?>
</div>